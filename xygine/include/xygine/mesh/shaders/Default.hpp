...
namespace xy
{
    namespace Shader3D
    {
        ...
        static const std::string version("#version 150\n");
        static inline std::string colouredFragment()
        { 
            std::string retVal;// = version;
            //retVal.append("#define TEXTURED\n");
            retVal.append(DefaultFragment);
            return std::move(retVal);
        }
    }
}

//#define COLOURED_VERTEX "#version 150\n" + xy::Shader3D::DefaultVertex
//#define COLOURED_FRAGMENT "#version 150\n"+xy::Shader3D::DefaultFragment
