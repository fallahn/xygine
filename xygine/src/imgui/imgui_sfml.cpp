...
void Init(sf::Window& window, sf::RenderTarget& target)
{
    ...
    style.Colors[ImGuiCol_SliderGrab]           = ImVec4(0.26f, 0.98f, 0.59f, 0.78f);
    ...
    style.Colors[ImGuiCol_ColumnHovered]        = ImVec4(0.26f, 0.98f, 0.59f, 0.78f);
    style.Colors[ImGuiCol_ColumnActive]         = ImVec4(0.26f, 0.98f, 0.59f, 1.00f);
