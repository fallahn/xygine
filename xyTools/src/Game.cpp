...
void Game::registerStates()
{
    ...
    m_stateStack.registerState<ParticleEditorState>(States::ID::ParticleEditor);
    m_stateStack.registerState<SpriteEditorState>(States::ID::SpriteEditor);
    m_stateStack.registerState<MaterialEditorState>(States::ID::MaterialEditor);
}
