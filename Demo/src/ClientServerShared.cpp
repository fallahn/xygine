    ...
    if (obj.getShape() == tmx::Object::Shape::Rectangle)
    {
        ...
        case CollisionType::Platform:
            ...
            entity.getComponent<CollisionComponent>().setCollisionMaskBits(
                CollisionFlags::Player | CollisionFlags::NPC | CollisionFlags::Fruit | CollisionFlags::Powerup | CollisionFlags::Bonus | CollisionFlags::MagicHat);
            break;
        case CollisionType::Solid:
            ...
            entity.getComponent<CollisionComponent>().setCollisionMaskBits(
                ...
                CollisionFlags::Powerup | CollisionFlags::Bonus | CollisionFlags::MagicHat);
            break;
