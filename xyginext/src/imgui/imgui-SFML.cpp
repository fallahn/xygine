...
void Init(sf::RenderTarget& target, bool loadDefaultFont)
{
    ...
    style.Colors[ImGuiCol_ChildWindowBg]        = ImVec4(0.30f, 0.30f, 0.30f, 0.50f);
    style.Colors[ImGuiCol_PopupBg]              = ImVec4(0.40f, 0.40f, 0.40f, 0.89f);
    style.Colors[ImGuiCol_Border]               = ImVec4(0.00f, 0.00f, 0.00f, 0.39f);
    style.Colors[ImGuiCol_BorderShadow]         = ImVec4(1.00f, 1.00f, 1.00f, 0.10f);
    style.Colors[ImGuiCol_FrameBg]              = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
    style.Colors[ImGuiCol_FrameBgHovered]       = ImVec4(0.19f, 0.38f, 0.21f, 0.40f);
    style.Colors[ImGuiCol_FrameBgActive]        = ImVec4(0.19f, 0.38f, 0.21f, 0.67f);
    ...
    style.Colors[ImGuiCol_Button]               = ImVec4(0.19f, 0.38f, 0.21f, 0.40f);
    style.Colors[ImGuiCol_ButtonHovered]        = ImVec4(0.19f, 0.38f, 0.21f, 1.00f);
    style.Colors[ImGuiCol_ButtonActive]         = ImVec4(0.09f, 0.38f, 0.21f, 1.00f);
    style.Colors[ImGuiCol_Header]               = ImVec4(0.19f, 0.38f, 0.21f, 0.31f);
    style.Colors[ImGuiCol_HeaderHovered]        = ImVec4(0.19f, 0.38f, 0.21f, 0.80f);
    style.Colors[ImGuiCol_HeaderActive]         = ImVec4(0.19f, 0.38f, 0.21f, 1.00f);
    style.Colors[ImGuiCol_Column]               = ImVec4(0.39f, 0.39f, 0.39f, 1.00f);
    style.Colors[ImGuiCol_ColumnHovered]        = ImVec4(0.19f, 0.38f, 0.21f, 0.78f);
    style.Colors[ImGuiCol_ColumnActive]         = ImVec4(0.19f, 0.38f, 0.21f, 1.00f);
    style.Colors[ImGuiCol_ResizeGrip]           = ImVec4(1.00f, 1.00f, 1.00f, 0.00f);
    style.Colors[ImGuiCol_ResizeGripHovered]    = ImVec4(0.19f, 0.38f, 0.21f, 0.67f);
    style.Colors[ImGuiCol_ResizeGripActive]     = ImVec4(0.19f, 0.38f, 0.21f, 0.95f);
    ...
    style.Colors[ImGuiCol_TextSelectedBg]       = ImVec4(0.19f, 0.38f, 0.21f, 0.35f);
...
void Image(const sf::Texture& texture, const sf::IntRect& textureRect,
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    Image(texture, sf::Vector2f(textureRect.width, textureRect.height), textureRect, tintColor, borderColor);
}

void Image(const sf::Texture& texture, const sf::Vector2f& size, const sf::IntRect& textureRect,
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ...
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ...
    Image(*texturePtr, size, sprite.getTextureRect(), tintColor, borderColor);
}
