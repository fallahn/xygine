...
void InterpolationSystem::onEntityAdded(xy::Entity entity)
{
    ...
    entity.getComponent<InterpolationComponent>().m_targetPoint.position = pos;
    entity.getComponent<InterpolationComponent>().m_previousPoint.position = pos;

    auto rotation = tx.getRotation();
    entity.getComponent<InterpolationComponent>().m_targetPoint.rotation = rotation;
    entity.getComponent<InterpolationComponent>().m_previousPoint.rotation = rotation;
}
